...
@(define-eval exn-eval (file "exn.ss"))

@defmodule[(planet untyped/unlib/exn) #:use-sources ((file "exn.ss"))]{

Utilities for raising, handling and printing exceptions.

@defproc[(display-exn [exn exn?]) void?]{

Prints the message and stack trace of @scheme[exn] to the current output port. Re-provided from @filepath{text-ui.ss} in SchemeUnit.
