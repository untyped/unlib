(module preprocess-test mzscheme
  ...
  (define preprocess-tests
    (test-suite
     "All tests for preprocess"
     (test-case
      "Applying a template returns the expected result"
     ...
     (test-case
      "Template bindings don't affect the current environment"
      (let ((dummy #f)
     ...
     (test-case
      "Template bindings are passed to the template"
