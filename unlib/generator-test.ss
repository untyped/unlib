(module generator-test mzscheme
  ...
  (define generator-tests
    (test-suite
     "generator.ss"
      ...
      (test-case
       "list->generator works when no default specified"
      ...
      (test-case
       "generator->list works as expected"
      ...
      (test-case
       "generator-accumulate works as expected"
       (check-equal? (generator-accumulate 
                      cons
                      null
      ...
      (test-case
       "generator-map works as expected"
      ...
      (test-case
       "generator-fold works as expected"
       (check-equal? (generator->list 
                      (generator-fold
                       +
                       0
      ...
      (test-case
       "generator-filter works as expected"
       (check-equal? (generator->list 
                      (generator-filter
                       even?
                       (list->generator (list 1 2 3 4 5))))
      ...
      (test-case
       "generator-filter-map works as expected"
       (check-equal? (generator->list 
      ...
      (test-case
       "generator-remove-duplicates works as expected"
       (check-equal? (generator->list 
      ...
      (test-case
       "generator-for-each works as expected"
      ...
      (test-case
       "generator-project works as expected"
     ...
     (test-case
      "generator-project with mask completely #t"
      (let ([generate (generator-project (list #t #t #t #t)
                                         (list->generator (list (list 0 0 0 0)
                                                                ...
                                                                (list 0 1 1 0)
                                                                (list 0 1 1 1))))])
        (check-equal? (generate) (list 0 0 0 0 (list)))
        (check-equal? (generate) (list 0 0 0 1 (list)))
        (check-equal? (generate) (list 0 0 1 0 (list)))
        (check-equal? (generate) (list 0 0 1 1 (list)))
        (check-equal? (generate) (list 0 1 0 0 (list)))
        (check-equal? (generate) (list 0 1 0 1 (list)))
        (check-equal? (generate) (list 0 1 1 0 (list)))
        (check-equal? (generate) (list 0 1 1 1 (list)))
        (check-pred generator-end? (generate))))
     
     (test-case
      "generator-project with mask completely #f"
     ...
     (test-case
      "generator-project passes non-list items straight through"
      (let ([generate (generator-project (list #t #t #f #f)
                                         (list->generator (list (list 0 0 0 0)
                                                                (list 0 0 0 1)
                                                                123
     ...
     (test-case
      "generator-project uses eq? by default"
      (let ([generate (generator-project (list #t #t #f #f)
                                         (list->generator (list (list "0" "0" "0" "0")
                                                                (list "0" "0" "0" "1")
                                                                123
     ...
     (test-case
      "generator-project can be configured to use equal? instead of eq?"
      (let ([generate (generator-project (list #t #t #f #f)
                                         (list->generator (list (list "0" "0" "0" "0")
                                                                (list "0" "0" "0" "1")
                                                                123
